...
export const PROSPECT_CALL: Scenario = {
  ...
  nodes: [
    ...
    },
    {
      ...
      choices: [
        choice('optimal', 'preuve', 'Alors soyons honnêtes : l’intégration pure n’ouvre pas le CIR. Si un projet interne sort du lot un jour, rappelez-moi — je ne vais pas vous vendre du vent.', { relation: 5, security: 8, mood: 3 }, { what: 'Vous refusez proprement.', why: 'Refuser un non-éligible protège votre réputation.', rule: 'Dire non tôt évite une mission toxique.', codexUnlock: 'cdx_dire_non' }, null),
        choice('acceptable', 'synthese', 'Dans ce cas, le potentiel est sans doute faible. On peut vérifier, mais je ne vous promets rien.', { relation: 3, security: 6 }, { what: 'Vous restez prudent.', why: 'Correct.', rule: 'On tempère les attentes.' }, null),
        choice('tempting', 'commercial', 'On trouvera bien un angle pour éligibiliser tout ça, prenons rendez-vous !', { relation: 4, security: -12 }, { what: 'Vous forcez un RDV.', why: 'Chercher un « angle » pour du non-éligible mène au redressement.', rule: 'On ne force pas l’éligibilité.' }, null),
        choice('poor', 'fermete', 'De l’intégration ? Aucun intérêt, au revoir.', { relation: -8 }, { what: 'Vous raccrochez sèchement.', why: 'Un refus brutal ferme une porte pour toujours.', rule: 'On refuse sans claquer la porte.' }, null),
      ],
    },
  ],
  outcome: {
