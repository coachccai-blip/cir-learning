  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'synthese', 'Bonne question. Avez-vous eu un projet dont la faisabilité technique n’était pas acquise ?', { relation: 4, security: 6, mood: 3 }, { what: 'Vous qualifiez d’emblée.', why: 'Une question simple et concrète sépare les vrais candidats des autres en trente secondes.', rule: 'On qualifie avant de vendre.' }, 'n2'),
        ...
        choice('tempting', 'commercial', 'Tout le monde y a droit, croyez-moi : on va vous trouver un très beau dossier.', { relation: 4, security: -10 }, { what: 'Vous survendez.', why: '« Tout le monde y a droit » est faux : le CIR suppose une incertitude scientifique.', rule: 'On ne promet jamais l’éligibilité au téléphone.' }, 'n2'),
        choice('poor', 'technique', 'Le CIR relève de l’article 244 quater B du CGI, sous conditions cumulatives, voyez-vous…', { relation: -6, mood: -4 }, { what: 'Vous récitez la loi.', why: 'Personne ne s’engage sur un article de loi au téléphone.', rule: 'Le bon registre avant le bon contenu.' }, 'n2'),
      ],
    },
    {
      id: 'n2',
      ...
      choices: [
        choice('optimal', 'preuve', 'Soyons honnêtes : l’intégration pure n’ouvre pas le CIR. Rappelez-moi si ça change.', { relation: 5, security: 8, mood: 3 }, { what: 'Vous refusez proprement.', why: 'Refuser un non-éligible protège le client et votre réputation.', rule: 'Dire non tôt évite une mission toxique.', codexUnlock: 'cdx_dire_non' }, null, { flags: ['prospect_decline'] }),
        ...
        choice('poor', 'fermete', 'De l’intégration ? Aucun intérêt pour moi, franchement. Je vous laisse, au revoir.', { relation: -8 }, { what: 'Vous raccrochez sèchement.', why: 'Un refus brutal ferme la porte pour toujours — y compris pour un vrai projet dans deux ans.', rule: 'On refuse sans claquer la porte.' }, null, { flags: ['prospect_decline_rude'] }),
      ],
    },
  ],
  outcome: OUT,
  ...
  nodes: [
    {
      ...
      choices: [
        ...
        choice('poor', 'fermete', 'C’est personnel, passez-le-moi directement, il attend mon appel.', { relation: -8, mood: -8 }, { what: 'Vous mentez au filtre.', why: 'Le mensonge se découvre en trente secondes et grille définitivement le contact.', rule: 'On ne ment jamais pour passer un barrage.' }, 'n2'),
      ],
    },
    {
      id: 'n2',
      ...
      choices: [
        choice('optimal', 'synthese', 'Message : « Le CIR peut financer vos travaux techniques. » Je rappelle demain 9 h.', { relation: 5, profitability: 3, mood: 3 }, { what: 'Message court + rappel programmé.', why: 'Vous laissez une trace utile ET vous gardez l’initiative du rappel.', rule: 'Un message se termine toujours par une date de rappel.' }, null, { flags: ['prospect_maybe'] }),
        ...
        choice('poor', 'fermete', 'Laissez tomber, je vois bien qu’on ne veut pas de moi dans cette maison.', { relation: -8 }, { what: 'Vous abandonnez avec humeur.', why: 'Vous perdez le contact ET laissez une mauvaise impression à celle qui tient l’agenda.', rule: 'L’assistante est une alliée, jamais un obstacle.' }, null, { flags: ['prospect_decline_rude'] }),
      ],
    },
  ],
  outcome: OUT,
  ...
  nodes: [
    {
      ...
      choices: [
        ...
        choice('tempting', 'commercial', 'Combien vous prennent-ils ? Je suis certain de pouvoir faire beaucoup moins cher.', { relation: -2, profitability: -6, mood: -3 }, { what: 'Vous vous positionnez sur le prix.', why: 'Attaquer par le tarif installe une relation de prestataire interchangeable.', rule: 'On ne gagne pas un dossier CIR sur le prix.' }, 'n2'),
    ...
    },
    {
      ...
      choices: [
        choice('optimal', 'preuve', 'Le jour d’un contrôle, c’est vous qui répondez. Je vous relis gratuitement le dernier.', { relation: 6, security: 8, profitability: 2, mood: 4 }, { what: 'Vous créez de la valeur sans attaquer.', why: 'Un diagnostic gratuit déplace le débat du prix vers la sécurité — votre terrain.', rule: 'La sécurité fiscale est un argument, pas une menace.', codexUnlock: 'cdx_preuve' }, null, { flags: ['prospect_maybe'] }),
        ...
        choice('tempting', 'commercial', 'Alors changez pour nous, on fera bien mieux. Je vous envoie un contrat aujourd’hui ?', { relation: -4, security: -6, mood: -5 }, { what: 'Vous brûlez l’étape.', why: 'Passer d’un aveu de doute à un contrat en une phrase fait fuir.', rule: 'Un doute exprimé n’est pas une intention d’achat.' }, null, { flags: ['prospect_sign'] }),
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'empathie', 'Ce qui fait redresser, ce n’est pas le CIR : c’est le CIR sans preuves.', { relation: 6, security: 8, mood: 5 }, { what: 'Vous validez la peur et la recadrez.', why: 'Distinguer « demander » et « demander mal » désamorce l’objection sans la nier.', rule: 'On ne combat pas une peur, on la précise.', codexUnlock: 'cdx_preuve' }, 'n2'),
        choice('acceptable', 'preuve', 'Le risque existe, je ne dirai pas le contraire. Il se maîtrise par un dossier documenté.', { relation: 4, security: 6, mood: 2 }, { what: 'Vous êtes honnête.', why: 'Juste, mais un peu froid face à quelqu’un qui exprime une inquiétude.', rule: 'L’honnêteté rassure — l’écoute davantage.' }, 'n2'),
        choice('tempting', 'commercial', 'Avec nous, aucun risque à craindre : on n’a jamais eu le moindre redressement.', { relation: 2, security: -12, mood: -2 }, { what: 'Vous promettez le risque zéro.', why: 'Le risque zéro n’existe pas ; le promettre détruit votre crédibilité dès la première question.', rule: 'Jamais de garantie absolue face à l’administration.' }, 'n2'),
    ...
    },
    {
      ...
      choices: [
        choice('optimal', 'preuve', 'Feuilles de temps réelles, comptes rendus datés, périmètre resserré.', { relation: 6, security: 8, profitability: 3, mood: 4 }, { what: 'Vous répondez par la méthode.', why: 'Une réponse concrète en trois points transforme l’anxiété en plan d’action.', rule: 'La preuve se constitue pendant les travaux, pas au contrôle.', codexUnlock: 'cdx_pieces' }, null, { flags: ['prospect_maybe'] }),
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'synthese', 'Le CIR n’a aucun seuil de taille, et les PME ont le remboursement immédiat.', { relation: 5, security: 6, mood: 4 }, { what: 'Vous corrigez avec un bénéfice concret.', why: 'Le remboursement immédiat parle bien plus à une TPE qu’un taux abstrait.', rule: 'Une idée fausse se corrige par un avantage concret.', codexUnlock: 'cdx_calendrier' }, 'n2'),
        choice('acceptable', 'preuve', 'Non, il n’y a pas de seuil : deux ingénieurs sur un vrai verrou suffisent.', { relation: 4, security: 6, mood: 3 }, { what: 'Vous corrigez factuellement.', why: 'Juste et clair, mais sans l’argument trésorerie qui fait mouche en TPE.', rule: 'Le CIR n’a pas de seuil de taille.' }, 'n2'),
        ...
        choice('poor', 'fermete', 'Effectivement, à huit personnes seulement, ça vaut rarement le coup de se lancer.', { relation: -4, profitability: -6, mood: -4 }, { what: 'Vous confirmez l’idée fausse.', why: 'Vous perdez un dossier potentiellement solide — et vous renforcez un mythe.', rule: 'Ne jamais valider une idée fausse par confort.' }, 'n2'),
      ],
    },
    {
      id: 'n2',
      ...
      choices: [
        choice('optimal', 'synthese', '« Qui ne marche pas comme on veut », c’est le vocabulaire même de l’incertitude technique.', { relation: 5, security: 6, profitability: 4, mood: 4 }, { what: 'Fourchette prudente et qualifiée.', why: 'Vous donnez un ordre de grandeur utile sans vous engager sur un chiffre ferme.', rule: 'Estimer sans s’engager.', codexUnlock: 'cdx_estimer' }, null, { flags: ['prospect_maybe'] }),
        ...
        choice('tempting', 'commercial', 'Facile, je vous dis 60 000 € les yeux fermés. On signe quand vous voulez ?', { relation: 6, security: -12, mood: 5 }, { what: 'Vous lâchez un chiffre ferme.', why: 'Un montant précis annoncé sans données devient une promesse dont vous répondrez au bilan.', rule: 'Un chiffre précis trop tôt coûte cher.' }, null, { flags: ['prospect_sign'] }),
        choice('poor', 'empathie', 'Difficile à dire… ça dépend vraiment de beaucoup de choses, vous savez.', { relation: -4, mood: -4 }, { what: 'Vous restez vague.', why: 'Le flou total sur une question directe donne l’impression que vous ne maîtrisez pas.', rule: 'Une fourchette prudente vaut mieux qu’un « ça dépend ».' }, null, { flags: ['prospect_maybe'] }),
      ],
    },
  ],
  outcome: OUT,
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'synthese', 'Autour de 20 % du CIR effectivement obtenu, au succès : rien touché, rien facturé.', { relation: 5, security: 4, profitability: 5, mood: 3 }, { what: 'Vous assumez le prix.', why: 'Répondre franchement à une question de prix crée plus de confiance que l’esquive.', rule: 'Un taux assumé se négocie mieux qu’un taux caché.' }, 'n2'),
        choice('acceptable', 'preuve', 'Au succès, un pourcentage du montant obtenu. Le taux dépend de la complexité.', { relation: 3, profitability: 3 }, { what: 'Vous conditionnez.', why: 'Correct, mais un interlocuteur direct entend une esquive.', rule: 'À une question directe, une réponse directe.' }, 'n2'),
        ...
        choice('poor', 'fermete', 'C’est le prix du marché : à prendre ou à laisser, comme vous voulez.', { relation: -8, mood: -6 }, { what: 'Vous fermez le dialogue.', why: 'Une réponse méprisante sur le prix termine l’appel — et la relation.', rule: 'Fermeté n’est pas brutalité.' }, 'n2'),
      ],
    },
    {
      id: 'n2',
      ...
      choices: [
        choice('optimal', 'preuve', 'Le formulaire prend une heure ; ce que vous payez, c’est le dossier qui tient.', { relation: 5, security: 8, profitability: 4, mood: 3 }, { what: 'Vous déplacez sur la valeur réelle.', why: 'La valeur du conseil CIR est dans le tri et la preuve, pas dans la déclaration.', rule: 'On vend la sécurité du dossier, pas le formulaire.' }, null, { flags: ['prospect_maybe'] }),
        choice('acceptable', 'synthese', 'Le travail réel, c’est la qualification des projets et la collecte des preuves.', { relation: 4, security: 5, profitability: 2 }, { what: 'Vous expliquez le travail.', why: 'Juste et pédagogique.', rule: 'Expliquer le travail justifie le prix.' }, null, { flags: ['prospect_maybe'] }),
        choice('tempting', 'commercial', 'Bon, écoutez, disons 12 % et on n’en parle plus, d’accord ?', { relation: 3, profitability: -12, mood: 2 }, { what: 'Vous cédez sous la pression.', why: 'Céder à la première objection apprend au client que tout est négociable.', rule: 'Une remise non contrepartie détruit la marge.' }, null, { flags: ['prospect_sign'] }),
        choice('poor', 'fermete', 'Si vous croyez vraiment que c’est simple, faites-le donc vous-même.', { relation: -10, mood: -8 }, { what: 'Vous vous vexez.', why: 'L’orgueil professionnel n’a jamais signé un dossier.', rule: 'On répond à une objection, on ne s’en offusque pas.' }, null, { flags: ['prospect_decline_rude'] }),
      ],
    },
  ],
  outcome: OUT,
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'synthese', 'Je vous l’envoie. Une question : avez-vous buté cette année sur un problème technique ?', { relation: 5, security: 5, profitability: 3, mood: 3 }, { what: 'Vous acceptez ET vous qualifiez.', why: 'Accepter l’esquive tout en posant une question garde la conversation vivante.', rule: 'Une plaquette envoyée sans question ne sera jamais lue.' }, 'n2'),
        ...
        choice('tempting', 'commercial', 'Une doc ne servira à rien, prenons plutôt rendez-vous tout de suite ensemble.', { relation: -4, mood: -4 }, { what: 'Vous forcez le passage.', why: 'Refuser la demande du prospect pour imposer la vôtre crispe immédiatement.', rule: 'On avance avec l’objection, pas contre elle.' }, 'n2'),
        choice('poor', 'fermete', 'Très bien, je vous envoie tout ça par mail. Bonne journée à vous.', { relation: 1, profitability: -6 }, { what: 'Vous subissez l’esquive.', why: 'Sans question ni date, cet appel est perdu et vous le savez déjà.', rule: 'Un appel sans prochaine étape est un appel gâché.' }, 'n2'),
      ],
    },
    {
      id: 'n2',
      ...
      choices: [
        choice('optimal', 'preuve', '« On n’a pas tranché », c’est le mot exact de l’incertitude. Vingt minutes en visio ?', { relation: 6, security: 6, profitability: 4, mood: 4 }, { what: 'Vous transformez l’esquive en rendez-vous.', why: 'La question qualifiante a fait surgir un vrai sujet — c’est là que l’appel bascule.', rule: 'Une bonne question vaut dix plaquettes.', codexUnlock: 'cdx_incertitude' }, null, { flags: ['prospect_maybe'] }),
        ...
        choice('tempting', 'commercial', 'Parfait, c’est éligible à coup sûr ! Je vous prépare le contrat dès ce soir.', { relation: 3, security: -12, mood: 2 }, { what: 'Vous concluez sur une phrase.', why: 'Une difficulté évoquée en trente secondes ne prouve pas l’éligibilité.', rule: 'Une phrase au téléphone n’est pas une qualification.' }, null, { flags: ['prospect_sign'] }),
        choice('poor', 'empathie', 'Ah, tant mieux ! Bon, je vous laisse regarder la documentation tranquillement.', { relation: 1, profitability: -6 }, { what: 'Vous laissez filer le signal.', why: 'Le prospect vient de vous offrir une ouverture et vous ne la saisissez pas.', rule: 'On rebondit sur un signal, on ne le range pas.' }, null, { flags: ['prospect_decline'] }),
      ],
    },
  ],
  outcome: OUT,
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'synthese', 'Si vos équipes ont buté cette année sur un problème technique sans solution, l’État finance 30 %.', { relation: 5, security: 4, profitability: 4, mood: 5 }, { what: 'Pitch calibré et demande claire.', why: 'Bénéfice + preuve de brièveté + demande précise : le format qui marche sur un pressé.', rule: 'Un pressé accorde du temps à qui n’en fait pas perdre.' }, 'n2'),
    ...
    },
    {
      ...
      choices: [
        ...
        choice('tempting', 'commercial', 'Quinze minutes ce sera un peu court, prévoyons plutôt une bonne heure.', { relation: -6, mood: -6 }, { what: 'Vous renégociez son temps.', why: 'Discuter le format qu’il vient de fixer annule le bénéfice de votre concision.', rule: 'On accepte le cadre du pressé, on l’exploite bien.' }, null, { flags: ['prospect_maybe'] }),
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'empathie', 'Une seule question et je vous laisse : vous a-t-on demandé ce que vous fabriquez ?', { relation: 6, security: 4, mood: 6 }, { what: 'Vous encaissez et vous vous différenciez.', why: 'Reconnaître la saturation puis poser une question de fond vous sort du lot des démarcheurs.', rule: 'Face à l’agacement : accuser réception, puis une seule question.', codexUnlock: 'cdx_client_difficile' }, 'n2'),
        choice('acceptable', 'synthese', 'Je vous crois volontiers et je n’insiste pas. Voulez-vous que je rappelle plus tard ?', { relation: 4, mood: 3 }, { what: 'Vous désamorcez poliment.', why: 'Respectueux, mais vous quittez l’appel sans avoir rien appris.', rule: 'Le retrait poli préserve la relation future.' }, 'n2'),
    ...
    },
    {
      ...
      choices: [
        choice('optimal', 'preuve', 'La masse salariale ne dit rien de l’éligibilité. Racontez-moi votre dernier casse-tête.', { relation: 6, security: 8, profitability: 3, mood: 5 }, { what: 'Vous prouvez la différence par la méthode.', why: 'Partir de la technique et non du chiffre est la vraie marque du conseil CIR sérieux.', rule: 'L’éligibilité se juge sur les travaux, jamais sur la masse salariale.' }, null, { flags: ['prospect_maybe'] }),
        choice('acceptable', 'synthese', 'C’est révélateur : l’éligibilité se juge sur la nature des travaux, pas sur des ratios.', { relation: 4, security: 6, mood: 3 }, { what: 'Vous posez le principe.', why: 'Juste, mais vous ne l’invitez pas à parler de son sujet.', rule: 'Après le principe, la question.' }, null, { flags: ['prospect_maybe'] }),
        ...
        choice('poor', 'fermete', 'Vous voyez bien que les autres sont mauvais. Signez plutôt avec moi.', { relation: -10, mood: -10 }, { what: 'Vous concluez brutalement.', why: 'Passer d’un aveu à une demande de signature est le réflexe qui fait raccrocher.', rule: 'Un point marqué n’est pas une signature.' }, null, { flags: ['prospect_decline_rude'] }),
      ],
    },
  ],
  outcome: OUT,
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'empathie', 'Merci de me le dire, j’essaierai d’être à la hauteur. Qu’est-ce qui vous amène ?', { relation: 6, security: 4, mood: 5 }, { what: 'Vous accueillez et vous ouvrez.', why: 'Une recommandation se honore par l’écoute, pas par un pitch immédiat.', rule: 'Sur un lead chaud, on écoute d’abord.' }, 'n2'),
    ...
    },
    {
      ...
      choices: [
        choice('optimal', 'fermete', 'Attention : son montant dépend de SES projets, pas des vôtres.', { relation: 4, security: 10, mood: 3 }, { what: 'Vous coupez court à l’ancrage.', why: 'Laisser s’installer le chiffre d’un autre crée une promesse implicite que vous ne tiendrez peut-être pas.', rule: 'Le montant d’un confrère n’est jamais une référence.', codexUnlock: 'cdx_estimer' }, null, { flags: ['prospect_maybe'] }),
        choice('acceptable', 'synthese', 'Même secteur ne veut pas dire même dossier. Voyons vos projets, puis une fourchette.', { relation: 4, security: 8, mood: 3 }, { what: 'Vous recadrez.', why: 'Juste et clair.', rule: 'Chaque assiette est spécifique.' }, null, { flags: ['prospect_maybe'] }),
        ...
        choice('poor', 'empathie', 'Sûrement, oui, ne vous inquiétez pas du tout pour le montant final.', { relation: 4, security: -10 }, { what: 'Vous laissez faire.', why: 'Le silence complice vaut acceptation : il retiendra 180 000 €.', rule: 'Ne pas démentir, c’est promettre.' }, null, { flags: ['prospect_sign'] }),
      ],
    },
  ],
  outcome: OUT,
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'empathie', '« Innovant » au sens commercial et « R&D » au sens fiscal, ce sont deux choses.', { relation: 4, security: 10, mood: 3 }, { what: 'Vous tempérez avec bienveillance.', why: 'Poser la distinction dès l’appel évite une déception majeure au bilan.', rule: 'Nouveauté commerciale ≠ R&D éligible.', codexUnlock: 'cdx_nouveaute' }, 'n2'),
        choice('acceptable', 'synthese', 'Il faudra distinguer ce qui relève du CIR : le site web et le packaging en sortent.', { relation: 2, security: 8, mood: 1 }, { what: 'Vous triez d’emblée.', why: 'Correct et factuel, un peu abrupt pour un enthousiaste.', rule: 'Le tri est le cœur du métier.' }, 'n2'),
        ...
        choice('poor', 'fermete', 'Un site web, ce n’est pas de la recherche. Vous confondez vraiment tout.', { relation: -10, mood: -10 }, { what: 'Vous humiliez.', why: 'Avoir raison sur le fond ne sert à rien si vous perdez l’interlocuteur.', rule: 'On corrige une erreur sans rabaisser la personne.' }, 'n2'),
      ],
    },
    {
      id: 'n2',
      ...
      choices: [
        choice('optimal', 'preuve', '« Qui ne tenait pas », six mois d’essais : voilà un vrai verrou.', { relation: 6, security: 8, profitability: 3, mood: 5 }, { what: 'Vous recentrez sur le vrai sujet.', why: 'Le prospect vient de livrer le seul projet réellement éligible : il fallait le repérer.', rule: 'Un vrai verrou vaut mieux qu’un large périmètre creux.', codexUnlock: 'cdx_verrou' }, null, { flags: ['prospect_maybe'] }),
        choice('acceptable', 'synthese', 'Ce projet-là est le bon candidat : on construira le dossier autour de lui.', { relation: 4, security: 8, mood: 3 }, { what: 'Vous resserrez le périmètre.', why: 'Juste : mieux vaut un petit dossier solide.', rule: 'Périmètre resserré = dossier défendable.' }, null, { flags: ['prospect_maybe'] }),
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'synthese', '30 % des dépenses retenues, restitué l’année suivante, risque lié aux preuves.', { relation: 6, security: 6, profitability: 4, mood: 5 }, { what: 'Vous répondez dans son ordre.', why: 'Reprendre la structure de la question d’un DAF est la marque du bon interlocuteur.', rule: 'Avec un financier : montant, délai, risque — dans cet ordre.', codexUnlock: 'cdx_calendrier' }, 'n2'),
        choice('acceptable', 'preuve', '30 % de l’assiette éligible, restituable l’année suivante, risque maîtrisé par la doc.', { relation: 4, security: 5, mood: 3 }, { what: 'Vous couvrez les trois points.', why: 'Juste, mais sans la structure explicite qu’il a demandée.', rule: 'Épouser la structure de la question rassure.' }, 'n2'),
        choice('tempting', 'commercial', 'Beaucoup, très vite, et sans le moindre risque si vous travaillez avec nous.', { relation: -6, security: -12, mood: -8 }, { what: 'Vous répondez en slogan.', why: 'Un DAF entend « je n’ai pas les chiffres » et met fin à l’entretien.', rule: 'Un financier ne s’achète pas avec des adjectifs.' }, 'n2'),
    ...
    },
    {
      ...
      choices: [
        ...
        choice('tempting', 'commercial', 'Ça n’arrivera pas, nos dossiers passent toujours sans aucune difficulté.', { relation: -4, security: -12, mood: -6 }, { what: 'Vous niez le risque.', why: 'Affirmer l’infaillibilité devant un DAF revient à avouer qu’on ne mesure rien.', rule: 'Le risque zéro n’existe pas ; le quantifier, si.' }, null, { flags: ['prospect_sign'] }),
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'empathie', 'Refonte de site et changement de logiciel : du développement courant, pas du CIR.', { relation: 4, security: 10, mood: 2 }, { what: 'Vous diagnostiquez immédiatement.', why: 'Laisser durer l’illusion coûterait des semaines à tout le monde.', rule: 'Intégration et refonte : développement courant, hors CIR.', codexUnlock: 'cdx_dev_courant' }, 'n2'),
        choice('acceptable', 'preuve', 'Ces travaux relèvent du développement courant. Un sujet technique non résolu, ailleurs ?', { relation: 4, security: 8, mood: 2 }, { what: 'Vous excluez puis vous vérifiez.', why: 'Bonne rigueur : on exclut, mais on laisse une chance à un autre projet.', rule: 'Exclure un projet n’exclut pas l’entreprise.' }, 'n2'),
    ...
    },
    {
      ...
      choices: [
        choice('optimal', 'empathie', 'Pas pour le CIR, non. Appelez-moi le jour où vous lancerez un vrai projet risqué.', { relation: 6, security: 10, mood: 4 }, { what: 'Vous refusez et vous gardez le lien.', why: 'Un refus honnête et expliqué transforme un non en relation durable.', rule: 'On peut gagner en refusant.', codexUnlock: 'cdx_dire_non' }, null, { flags: ['prospect_decline'] }),
        choice('acceptable', 'synthese', 'Pas sur le CIR. D’autres dispositifs existent peut-être, mais ce n’est pas mon domaine.', { relation: 4, security: 8, mood: 3 }, { what: 'Vous refusez proprement.', why: 'Honnête, et vous ne sortez pas de votre expertise.', rule: 'On refuse aussi ce qu’on ne maîtrise pas.' }, null, { flags: ['prospect_decline'] }),
        ...
        choice('poor', 'fermete', 'Rien du tout de mon côté. Vous me faites perdre mon temps, au revoir.', { relation: -12, mood: -12 }, { what: 'Vous humiliez un prospect de bonne foi.', why: 'Il parlera de vous — en mal — à tout son réseau professionnel.', rule: 'Un non se dit avec respect, toujours.' }, null, { flags: ['prospect_decline_rude'] }),
      ],
    },
  ],
  outcome: OUT,
  ...
  nodes: [
    {
      ...
      choices: [
        choice('optimal', 'preuve', 'Le rappel portait-il sur la nature des projets, ou sur l’absence de justificatifs ?', { relation: 5, security: 8, mood: 4 }, { what: 'Vous cherchez la cause exacte.', why: 'Un rejet pour défaut de preuve se corrige ; un rejet sur la nature des travaux, non.', rule: 'Un redressement a une cause précise — il faut la connaître.' }, 'n2'),
        choice('acceptable', 'empathie', 'Quatre-vingt mille euros, c’est une somme. Que vous avait-on reproché exactement ?', { relation: 5, security: 6, mood: 4 }, { what: 'Vous compatissez et vous ouvrez.', why: 'L’écoute désamorce ; la question précise viendra ensuite.', rule: 'On écoute avant de diagnostiquer.' }, 'n2'),
        choice('tempting', 'commercial', 'Votre ancien cabinet a très mal travaillé, c’est évident. Avec nous ça n’arriverait pas.', { relation: -4, security: -8, mood: -5 }, { what: 'Vous accusez sans savoir.', why: 'Vous ignorez le dossier — et le client a peut-être lui-même forcé la main.', rule: 'On ne juge pas un dossier qu’on n’a pas lu.' }, 'n2'),
    ...
    },
    {
      ...
      choices: [
        choice('optimal', 'preuve', 'Vos projets étaient éligibles : seule la preuve manquait, et ça, ça se corrige.', { relation: 7, security: 10, profitability: 3, mood: 6 }, { what: 'Vous transformez le traumatisme en diagnostic.', why: 'Distinguer « projets rejetés » et « preuves manquantes » redonne une perspective réaliste.', rule: 'La preuve se constitue pendant les travaux, pas au contrôle.', codexUnlock: 'cdx_preuve' }, null, { flags: ['prospect_maybe'] }),
