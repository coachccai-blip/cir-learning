...
export const CARDSETS: Cardset[] = [
  {
    ...
    cards: [
      ...
      { id: 'ag9', title: 'Prototype d’un doseur pour la ligne pilote', description: 'Premier exemplaire d’un doseur conçu en interne pour un nouveau produit, à partir de composants du commerce.', clues: ['Prototype de nouveau produit', 'Techniques connues'], verdict: 'CII', explanation: 'Nouveau produit sans verrou de recherche : innovation (CII), pas CIR.', codexRef: 'cdx_cii' },
  ...
  },
  {
    ...
    cards: [
      ...
      { id: 'sa9', title: 'Prototype d’un assistant de requêtes en langage naturel', description: 'Nouvelle fonction produit assemblée à partir de briques existantes, sans incertitude scientifique.', clues: ['Prototype de nouveau produit', 'PME'], verdict: 'CII', explanation: 'Nouveauté produit sans verrou : CII, à ne pas confondre avec le CIR.', codexRef: 'cdx_cii' },
  ...
  },
  {
    ...
    cards: [
      ...
      { id: 'in10', title: 'Prototype d’un conditionnement réutilisable', description: 'Premier exemplaire d’un emballage navette conçu pour un client, avec des matériaux courants.', clues: ['Prototype de nouveau produit', 'Sans verrou'], verdict: 'CII', explanation: 'Prototype de nouveau produit sans incertitude scientifique : CII.', codexRef: 'cdx_cii' },
    ],
  },
  {
    id: 'cards_biotech',
    ...
    cards: [
      ...
      { id: 'bi10', title: 'Prototype d’un kit de prélèvement patient', description: 'Nouveau dispositif d’usage, conçu avec des composants qualifiés existants.', clues: ['Prototype de nouveau produit'], verdict: 'CII', explanation: 'Nouveau produit sans verrou de recherche : CII, pas CIR.', codexRef: 'cdx_cii' },
    ],
  },
  {
    id: 'cards_green',
  ...
  },
  {
    ...
    cards: [
      ...
      { id: 'se5', title: 'Prototype interne d’un outil de planification', description: 'Nouvel outil pour les équipes, assemblé à partir de briques connues.', clues: ['Prototype interne', 'Sans verrou'], verdict: 'CII', explanation: 'Nouveauté d’usage sans incertitude scientifique : CII.', codexRef: 'cdx_cii' },
      ...
      { id: 'se9', title: 'Lever la limite de robustesse du moteur d’anonymisation', description: 'Aucune méthode publiée ne résiste aux attaques par recoupement sur ces jeux de données ; plusieurs approches sont testées et écartées.', clues: ['État de l’art insuffisant', 'Incertitude'], verdict: 'RD', explanation: 'Incertitude sur l’aboutissement, travaux internes : R&D éligible.', codexRef: 'cdx_incertitude' },
      { id: 'se10', title: 'Expérimentations comparées sur données rares', description: 'Protocoles datés, hypothèses invalidées conservées, métriques publiées en interne.', clues: ['Protocole', 'Résultats négatifs conservés'], verdict: 'RD', explanation: 'Démarche expérimentale tracée sur un sujet interne : R&D.', codexRef: 'cdx_demarche' },
    ],
  },
];
